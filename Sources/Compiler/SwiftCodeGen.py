...
class Swift3CodeGenerator:
    ...
    def generate_request_init_and_default_member_var(self, request_context, uri_context):
        ...
        self.push_indent()
        self.write_line('return BaseRequestConfiguration.create(from: manager.configuration, request: self)')
        self.pop_indent()
        self.write_line('}')
        ...
        self.pop_indent()
        self.write_line('}')
        self.write_line('var manager: RequestManager = BaseRequestManager.shared')
