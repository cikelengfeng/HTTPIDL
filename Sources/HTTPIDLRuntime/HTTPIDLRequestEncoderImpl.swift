...
enum HTTPJSONRequestEncoderError: Error {
...
enum HTTPMultipartRequestEncoderError: Error {
...
struct HTTPURLEncodedFormRequestEncoder: HTTPRequestEncoder {
    static let shared = HTTPURLEncodedFormRequestEncoder()
